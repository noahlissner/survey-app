	...
	return (
		<div className='overflow-hidden relative w-full bg-blue-300 dark:bg-blue-800 rounded-[20px] flex items-center'>
			<input
				...
				id={name}
				name={name}
				className={`autofill:bg-yellow-300 bg-transparent block ${
					label ? 'px-4 pb-3 pt-6' : 'p-4'
				} w-full focus:outline-none focus:border-blue-600 peer text-lg dark:text-white`}
				placeholder=' '
				onChange={onChange}
				value={value}
			/>
