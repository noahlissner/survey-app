  ...
  return (
    <div className="relative overflow-hidden h-screen w-screen bg-gradient-to-r from-blue-100 to-blue-300 flex justify-center">
      ...
      <main className="h-full w-9/12 flex justify-center flex-col">
        ...
        <form
          onSubmit={onSubmit}
          className="flex flex-col items-center gap-5 w-fit"
        >
          <div className="flex w-full justify-between">
            <div className="bg-blue-300 shadow-md rounded-xl w-[215px] p-4 flex gap-3 items-center">
              <div className="flex flex-col">
                <label className="text-gray-400 text-sm" htmlFor="firstName">
                  First name
                </label>
                <input
              ...
              <div>
                <BsPersonLinesFill className="text-lg" />
              </div>
            </div>
            <div className="bg-blue-300 shadow-md rounded-xl w-[215px] p-4 flex gap-3 items-center">
              <div className="flex flex-col">
                <label className="text-gray-400 text-sm" htmlFor="lastName">
                  Last name
                </label>
                <input
                  className="w-full bg-transparent border-b-2 border-b-gray-400"
          ...
          <input
            className="bg-blue-400 w-fit py-5 px-8 mt-10 rounded-full text-white"
            type="submit"
      ...
      <img
        className="absolute h-[70rem] bottom-[-15rem] right-[-15rem]"
